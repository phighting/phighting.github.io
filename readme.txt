Tag Cloud FX version 1.0.7.8053

Hello and thank you for using Tag Cloud FX. By downloading our FlashXML product you have become part of the FX community and we are very pleased to welcome you and wish you a long-lasting FlashXML experience.

The Tag Cloud FX's features are:
	- roll over effects
	- multiple configurable properties for shade and background
	- roll out speed and angle
	- customizable tags perspective, radius and offset
	- different properties for text
...
- for HTML: www.flashxml.net/tag-cloud.html#swmi-free-install
- for Flash: www.flashxml.net/tag-cloud.html#swmi-free-flash
- for WordPress: www.flashxml.net/tag-cloud.html#swmi-wordpress
- for Joomla: www.flashxml.net/tag-cloud.html#swmi-joomla
- for Facebook: www.flashxml.net/tag-cloud.html#swmi-facebook

By downloading our Tag Cloud FX you have access to one of the most customizable Flash component on the internet. All of our components are XML driven, so there is no need to use Adobe Flash to change the component's attributes or its assets.
...
Version 1.0.7.8053 - 24-Jan-12
	- fixed issue with stage align and scale mode

Version 1.0.6.6376 - 26-Jul-11
	- added new features for Background Properties

Version 1.0.5.4038 - 14-Feb-11
	- renamed tagItems attribute to assets in the settings.xml file

Version 1.0.4.3448 - 12-Jan-11
	- added the possibility to specify which settingsXML to load through Component Inspector in Flash

Version 1.0.3.2334 - 06-Nov-10
	- added the borderAlpha option for tags on roll over

Version 1.0.2.1368 - 27-Sep-10
	- added the posibility to load images from different domain

Version 1.0.1.1334 - 27-Sep-10
	- bug fixed for the property rollOutSpeed

This is a list with all the product's attributes and a short description about what each attribute does:
componentWidth - product's width
componentHeight - product's height
assets - tags set
aspect - cloud shape
offsetX - cloud's horizontal position
offsetY - cloud's vertical position
radius - cloud's size
perspective - cloud's perspective
rollOutSpeed - rotation speed
speed - mouse rotation speed
stopingSpeed - speed change delay
rollOutAngle - rotation angle
picWidth - tag image's width
picHeight - tag image's height
picPosition - tag image's alignment
picDistance - tag image's position
width - text fields' width
backgroundColor - text fields' background color
bgAlpha - text fields' background opacity
cornerRadius - text fields' corner adjustment
borderWidth - text fields' border size
borderColor - text fields' border color
borderAlpha - text fields' border opacity
overBorderWidth - text fields' border size on mouse over
overBorderColor - text fields' border color on mouse over
overBorderAlpha - text fields' border opacity on mouse over
